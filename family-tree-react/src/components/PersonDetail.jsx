...
function PersonDetail() {
    ...
    const [svgLoading, setSvgLoading] = useState({ ancestors: true, mrca: true });
    ...
    useEffect(() => {
        ...
        setCensusRecords([]);
        setPhotos([]);
        setSvgLoading({ ancestors: true, mrca: true });
        ...
        <div className="page person-detail">
            ...
            <div className={`person-content-layout${censusRecords.length > 0 ? (censusSidebarOpen ? ' sidebar-open' : ' sidebar-closed') : ''}`}>
                <div className="person-trees">
                        ...
                        <div className="svg-section">
                            ...
                            {ancestorsOpen && (
                                svgLoading.ancestors
                                    ...
                                    : ancestorSvg && <ZoomableSvg svgContent={ancestorSvg} onClick={handleSvgClick} />
                            )}
                        </div>
                    )}
                    ...
                    {descendantCount > 0 && (
                        <div className="svg-section">
                            <Link to={`/tree/${personId}`} className="view-tree-link">
                                View Descendants ({descendantCount}) &rarr;
                            </Link>
                        </div>
                    )}
                        ...
                        <div className="svg-section">
                            ...
                            {mrcaOpen && (
                                svgLoading.mrca
                                    ...
                                    : mrcaSvg && <ZoomableSvg svgContent={mrcaSvg} onClick={handleSvgClick} />
                            )}
                        </div>
                    )}
                </div>
