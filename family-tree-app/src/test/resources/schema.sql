...
CREATE TABLE IF NOT EXISTS person_url (
    id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS ancestry_tester (
...
CREATE TABLE IF NOT EXISTS ancestry_dna_match (
...
CREATE TABLE IF NOT EXISTS match_cluster (
    id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
ALTER TABLE tree ADD CONSTRAINT IF NOT EXISTS fk_tree_dna_test FOREIGN KEY (dna_test_id) REFERENCES ancestry_tester(dna_test_id);
